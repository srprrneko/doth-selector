...
public class ConditionBuilder<T> {
    ...
    public ConditionBuilder<T> eq(String field, Object value) {
        ...
        appendCondition(false, field + " = ?", value);
        return this;
    }

    // todo: 后续拓展
    public ConditionBuilder<T> orEq(String field, Object value) {
        recordField(field);

        appendCondition(true, field + " = ?", value);
        return this;
    }
    ...
    public ConditionBuilder<T> between(String field, Object start, Object end) {
        ...
        appendCondition(false, field + " between ? and ?", start, end);
        return this;
    }
    ...
    public ConditionBuilder<T> like(String field, String pattern) {
        ...
        appendCondition(false, field + " like ?", pattern);
        return this;
    }
    ...
    public ConditionBuilder<T> in(String field, Object... values) {
        ...
        appendCondition(false, field + " in (" + placeholders + ")", values);
        return this;
    }
    ...
    public ConditionBuilder<T> nin(String field, Object... values) {
        ...
        String placeholders = String.join(",", Collections.nCopies(values.length, "?"));
        appendCondition(false, field + " not in (" + placeholders + ")", values);
        return this;
    }
    ...
    public ConditionBuilder<T> isNull(String field) {
        ...
        appendCondition(false, field + " is null");
        return this;
    }
    ...
    public ConditionBuilder<T> isNotNull(String field) {
        ...
        appendCondition(false, field + " is not null");
        return this;
    }
    ...
    public ConditionBuilder<T> raw(String rawClause, Object... values) {
        appendCondition(false, rawClause, values);
        return this;
    }
    ...
    private void appendCondition(boolean isOr, String condition, Object... values) {
        if (whereClause.length() > 0) {
            if (isOr) {
                whereClause.append(" or ");// StringBuilder追加字符串效率高于String拼接
            } else {
