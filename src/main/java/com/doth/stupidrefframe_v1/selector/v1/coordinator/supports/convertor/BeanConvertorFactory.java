...
import com.doth.stupidrefframe_v1.selector.v1.coordinator.supports.convertor.join.JoinBeanConvertor;
import com.doth.stupidrefframe_v1.selector.v1.coordinator.supports.convertor.strict.StrictBeanConvertorLv;
import com.doth.stupidrefframe_v1.selector.v1.coordinator.supports.convertor.strict.StrictBeanConvertor;
...
public class BeanConvertorFactory {
    ...
    static {
        ...
        instances.put(ConvertorType.LIGHT, new StrictBeanConvertorLv()); // 轻量级 light_version
