package com.doth.stupidrefframe_v1.selector.v1.core;
...
import com.doth.stupidrefframe_v1.selector.v1.executor.enhanced.query.BuilderQueryExecutorPro;
import com.doth.stupidrefframe_v1.selector.v1.executor.enhanced.query.DirectQueryExecutorPro;
import com.doth.stupidrefframe_v1.selector.v1.executor.enhanced.query.RawQueryExecutorPro;
import com.doth.stupidrefframe_v1.selector.v1.core.factory.CreateExecutorFactory;
import com.doth.stupidrefframe_v1.selector.v1.core.factory.impl.DefaultCreateExecutorFactory;
...
public class SelectorV2<T> {
    ...
    public static <T> DirectQueryExecutorPro<T> direct_join(Class<T> beanClass) {
    ...
    public DirectQueryExecutorPro<T> direct_join() {
        return getExecutor(beanClass, ExecutorType.DIRECT_PRO, DirectQueryExecutorPro.class);
    }
