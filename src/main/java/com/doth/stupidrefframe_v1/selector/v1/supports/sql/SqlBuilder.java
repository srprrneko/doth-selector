...
import com.doth.stupidrefframe_v1.selector.v1.util.AnnoNamingConvertUtil;
import com.doth.stupidrefframe_v1.selector.v1.util.ConditionResolver;

import java.lang.reflect.Field;
import java.util.LinkedHashMap;

import static com.doth.stupidrefframe_v1.selector.v1.util.AnnoNamingConvertUtil.camel2Snake;
...
public class SqlBuilder {
    ...
    private static void buildConditions(StringBuilder sqlBuilder, LinkedHashMap<String, Object> conditions) {
        conditions.forEach((column, value) -> {
            // 动态生成操作符
            String operator = ConditionResolver.resolveOperator(value);
            // 处理 IN 子句占位符
            String placeholders = ConditionResolver.resolvePlaceholders(value);
    ...
    // ----------------- 带自定义子句的全局sql -----------------
    public static String appendWhereClause(String baseSql, LinkedHashMap<String, Object> condBean, String strClause) {
