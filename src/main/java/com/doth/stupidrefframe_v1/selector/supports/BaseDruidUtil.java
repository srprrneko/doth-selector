...
public class BaseDruidUtil {
    ...
    private static void initDataSourceWithConfig() {
        try (InputStream input = BaseDruidUtil.class.getClassLoader()
    ...
    public static void main(String[] args) throws SQLException {
        System.out.println("BaseDruidUtil.dataSource.getConnection() = " + BaseDruidUtil.dataSource.getConnection());
    }
}