...
public class DirectQueryExecutor<T> extends BasicKindQueryExecutor<T> {
    ...
    public List<T> query2Lst() {
        return coordinator.mapSqlCond(beanClass,(LinkedHashMap<String, Object>) null);
    }

    public List<T> query2Lst(T t) {
        LinkedHashMap<String, Object> condMap = coordinator.extractFields(t);
        return coordinator.mapSqlCond(beanClass, condMap);
    }
    ...
    public List<T> query2Lst(LinkedHashMap<String, Object> cond) {
        return coordinator.mapSqlCond(beanClass, cond);
    }

    public List<T> query2Lst(LinkedHashMap<String, Object> cond, String condClause) {
        return coordinator.mapSqlCond(beanClass, cond, condClause);
    }



    public T query2T(LinkedHashMap<String, Object> cond) {
        return coordinator.getSingleResult(coordinator.mapSqlCond(beanClass, cond));
    }
